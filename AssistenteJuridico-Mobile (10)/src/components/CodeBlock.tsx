...
// Renderiza texto com blocos de código detectados automaticamente
...
const styles = StyleSheet.create({
  ...
  lang: { color: "#7d8590", fontSize: 11, fontFamily: "monospace" },
  copyBtn: { flexDirection: "row", alignItems: "center", gap: 4 },
  copyText: { color: COLORS.textMuted, fontSize: 11 },
  scroll: { padding: 12 },
  code: { fontFamily: "monospace", fontSize: 13, color: "#e6edf3", lineHeight: 20 },
  inlineCode: {
